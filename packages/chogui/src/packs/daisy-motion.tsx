...
// line up. Namespaced under `chogui-hover-gallery` so it can't affect other use.
const HOVER_GALLERY_STYLES = `.chogui-hover-gallery > img{margin:0}`;
...
function HoverGallery({ children }: { children: ReactNode }) {
	return <figure className="hover-gallery chogui-hover-gallery max-w-sm my-4">{children}</figure>;
}
